...
knitr::include_graphics("images/dialogo.png")
```
---
**Participación política**
...
knitr::include_graphics("images/formal-activismo.png")
```
---
...
-	Socialización política familiar directa (SPFD): Se presenta cuando las familias de los jóvenes son políticamente activas, participando en actividades políticas tempranamente, lo que conllevaría a desarrollar mayores niveles de participación en el futuro. 

-	Socialización política familiar indirecta (SPFI): Ocurre cuando en el contexto familiar se discute con frecuencia sobre temas relacionados con política y actualidad, lo que facilita la transmisión del lenguaje político, de las preferencias y del interés por la política.



--
**Variables de recursos culturales familiares**
...
H1. Jóvenes provenientes de familias con mayores niveles de participación política y/o con mayores niveles de conversación política presentarán mayores niveles de participación política.

H2a. Jóvenes que crecen en familias con mayores recursos culturales presentarán mayores niveles de participación política formal y activista no disruptiva.

H2b. Jóvenes que crecen en familias con mayores recursos culturales presentarán menores niveles de participación política activista disruptiva.

H3. Jóvenes que asisten a escuelas con mayores prácticas de socialización política presentarán mayores niveles de participación política.

H4. En escuelas que desarrollan mayores niveles de apertura a la discusión en el aula y/o mayor número de actividades cívicas, la asociación entre las prácticas de participación de los padres con los niveles de participación de los jóvenes será menos intensa.

H5. En escuelas que desarrollan mayores niveles de apertura a la discusión en el aula y/o mayor número de actividades cívicas, la asociación entre los recursos culturales de la familia con los niveles de participación de estos jóvenes será menos intensa.
---
**Modelo de Hipótesis**
...
* La familia es un factor de socialización política relevante en la actualidad, ya que tanto las prácticas de participación de los padres como los recursos culturales parecen estar conectados con las prácticas de participación de los hijos. Esta situación es una fuente de desigualdad entre aquellos estudiantes con familias polítizadas y con mayores recursos culturales, respecto a los estudiantes que tienen familias menos politizadas. Pareciera ser que la manzana no cae tan lejos del árbol.

* Como se ha visto en la literatura, la escuela sigue siendo un elemento importante para entender la adhesión a formas formales de participación política de los jóvenes. Sin embargo, a partir de la evidencia producida, cabe seguir porfundizando en su rol de moderador de la participación política de los jóvenes con las desigualdades de origen. ¿Potencia o mitiga las desigualdades de origen?
